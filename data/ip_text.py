...
LEDE = (
 'The White Book card, checked line by line. Corrected figures keep the original. Two guidelines '
 'postdate it and rewrite several rows: <b>2025 AHA/ACC HTN</b>, <b>2026 AHA/ASA stroke</b>.'
)

DEFS = [
 {'k': 'mild', 'title': 'Asx elevated BP',
  'thr': '&ge;130/80 and &lt;180/110&ndash;120 &middot; no acute TOD',
  'body': '<em>Card: &ldquo;&le;180 and DBP &le;110&rdquo;</em> &mdash; no lower bound, overlaps the row below.'},
 {'k': 'marked', 'title': 'Severe HTN',
  'old': 'was &ldquo;HTN urgency&rdquo;',
  'thr': '&gt;180/120 &middot; no acute TOD',
  'body': '2025 AHA/ACC term. The 2024 statement says <b>asx markedly elevated BP</b>, &gt;180/110&ndash;120.'},
...
EOD_NOTE = (
 '<sup class="addmark">+</sup> on the 2024 AHA list, not the card. Card lists <b>TIA</b> and <b>hematuria</b>; '
 ' neither is in any source list. TOD occurs below 180/110&ndash;120 &mdash; the threshold is not a wall.'
)

ASSESS = (
 '<b>1 MAR.</b> Home meds not restarted is the commonest cause &mdash; 41% of PRN patients were not on theirs. &nbsp; '
 '<b>2 Cuff.</b> Too small reads high: regular cuff on an XL arm <b>+19.5 SBP</b>; arm unsupported +6.5. &nbsp; '
...
NOTES = [
 {'t': '<b>Control</b> decides pump vs syringe. '
       ...
       '<span class="ctrlb t0">unpredictable</span> &mdash; hydralazine and enalaprilat.'},
 {'warn': True,
  't': '<b>PRN antihypertensives.</b> 93% of PRN doses are IV. 2&times; risk of a &gt;25% SBP drop '
       'in 1 h, 24% more AKI. <b>84.5% of IV doses went to an SBP &lt;180.</b> 2024 AHA advises '
       'against the orders outright.'},
 {'t': '<b>Not approved IV for HTN:</b> metoprolol (MI only), diltiazem (AF, PSVT), furosemide '
       '(edema). NTG ointment is approved for angina only. Push IV metoprolol for 190/110 and the '
       'label&rsquo;s own data say the 110 does not move.'},
 {'t': '<b>Workup is small and symptom-directed.</b> Routine: BMP, CBC, CXR, ECG, volume status, '
       'pulses, <b>fundi</b>. Not routine: troponin, UA, smear, head CT. Five-symptom screen (CP, '
       'dyspnea, HA, visual, neuro) <b>NPV ~99%</b>. Head CT is <em>insensitive</em> for HTN '
       'encephalopathy.'},
 {'warn': True,
  't': '<b>Off the drip:</b> start PO <em>while it runs</em>, then wean. Nicardipine loses half its '
       'effect in 30 min and no PO agent peaks that fast. &nbsp; '
       '<b>ACEi/ARB on the morning of surgery is unsettled</b> &mdash; 2024 ACC/AHA says hold 24 h, '
       'the 2026 anaesthetists say take it. Ask.'},
]
