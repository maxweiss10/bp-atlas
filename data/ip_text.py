...
ASSESS = (
 ...
 '<b>2 Cuff.</b> Too small reads high: regular cuff on XL arm <b>+19.5 SBP</b>; arm unsupported '
 '+6.5. &nbsp; '
 '<b>3 Cause.</b> Pain &middot; retention &middot; nausea &middot; hypoxia &middot; withdrawal '
 '(EtOH, benzo, clonidine, BB) &middot; steroids &middot; NSAIDs &middot; sympathomimetics '
 '&middot; CNI &middot; VEGFi &middot; OSA &middot; NPO. &nbsp; '
 '<b>4 Wait.</b> Recheck after 30 min rest. &nbsp; '
 '<b>5 Workup</b> is small + sx-directed. Routine: BMP, CBC, CXR, ECG, volume, pulses, '
...
TOP_NOTES = [
 {'warn': True,
  't': '<b>PRN antihypertensives.</b> 93% of PRN doses are IV. 2&times; risk of &gt;25% SBP drop '
       '&lt;1h, 24% more AKI, and <b>84.5% of IV doses went to SBP &lt;180</b>. 2024 AHA advises '
...
NOTES = [
 {'t': '<b>Control</b> decides pump vs syringe. '
       ...
       '<b>Not approved IV for HTN:</b> metoprolol (MI only), diltiazem (AF, PSVT), furosemide '
       '(edema); NTG ointment = angina only.'},
 {'warn': True,
  't': '<b>Off the gtt:</b> start PO <em>while it runs</em>, then wean &mdash; nicardipine loses '
       '&frac12; its effect in 30 min and no PO agent peaks that fast. &nbsp; '
       '<b>ACEi/ARB the AM of surgery is unsettled</b>: 2024 ACC/AHA says hold 24h, the 2026 '
       'anaesthetists say take it. Ask.'},
]
