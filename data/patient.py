...
PROFILES = [
    ...
    dict(id='cad', label='Coronary disease or prior MI', short='CAD/MI', group='Cardiac',
    ...
    dict(id='afib', label='AF needing rate control', short='AF', group='Cardiac',
         promote=[('cls:BB', 'Rate control and blood pressure in one drug'),
                  ('sub:nonDHP', 'Rate control and blood pressure in one drug')]),
    dict(id='brady', label='Bradycardia or AV block', short='Brady/AVB', group='Cardiac',
    ...
    # ---- renal ------------------------------------------------------------
    dict(id='ckd', label='CKD with albuminuria', short='CKD+alb', group='Renal',
    ...
    dict(id='hyperk', label='High potassium or advanced CKD', short='HyperK', group='Renal',
    ...
    # ---- metabolic --------------------------------------------------------
    dict(id='diabetes', label='Diabetes with albuminuria', short='DM+alb', group='Metabolic',
    ...
    dict(id='migraine', label='Migraine', short='Migraine', group='Neurologic',
         ...
         note='Verapamil is Level U for migraine - its prophylactic role is cluster headache, not '
              'migraine.'),
    dict(id='cluster', label='Cluster headache', short='Cluster HA', group='Neurologic',
    ...
    dict(id='tremor', label='Essential tremor', short='Tremor', group='Neurologic',
    ...
    # ---- other ------------------------------------------------------------
    dict(id='angioedema', label='Prior ACEi angioedema', short='Prior angioedema', group='Other',
    ...
    dict(id='cirrhosis', label='Cirrhosis with ascites', short='Cirrhosis', group='Other',
    ...
    dict(id='lithium', label='On lithium', short='Lithium', group='Other',
