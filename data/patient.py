...
PROFILES = [
    dict(id='pregnancy', label='Pregnant or planning', group='Must avoid',
         ...
         note='Labetalol and nifedipine ER are the usual choices, with methyldopa. '
              'Labetalol is not in this model, so it cannot be ranked here.'),
    dict(id='asthma', label='Asthma or COPD', group='Must avoid',
    ...
    dict(id='hfref', label='Heart failure, reduced EF', group='Must avoid',
         ...
         note='Treat this as heart-failure therapy, not blood-pressure therapy - '
              'the regimen is driven by mortality benefit, not mmHg.'),
    dict(id='ckd', label='CKD with albuminuria', group='Steer toward',
    ...
    dict(id='diabetes', label='Diabetes with albuminuria', group='Steer toward',
         promote=[('cls:ACEi', 'Slows nephropathy'), ('cls:ARB', 'Slows nephropathy')]),
    dict(id='cad', label='Coronary disease or prior MI', group='Steer toward',
         promote=[('cls:BB', 'The setting where a beta blocker is genuinely first-line'),
                  ('cls:ACEi', 'Mortality benefit after MI'), ('cls:ARB', 'Alternative to an ACEi')]),
    dict(id='afib', label='AF needing rate control', group='Steer toward',
         promote=[('cls:BB', 'Rate control plus blood pressure in one drug'),
                  ('sub:nonDHP', 'Rate control plus blood pressure in one drug')]),
    dict(id='gout', label='Gout', group='Steer toward',
    ...
    dict(id='osteoporosis', label='Osteoporosis', group='Steer toward',
         promote=[('sub:thiazide', 'Reduces urinary calcium loss')]),
    dict(id='migraine', label='Migraine', group='Steer toward',
         promote=[('propranolol', 'Also prevents migraine')]),
    dict(id='black', label='Black adult, no CKD or HF', group='Steer toward',
    ...
    dict(id='hyperk', label='High potassium or advanced CKD', group='Must avoid',
