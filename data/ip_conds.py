...
},
{
 ...
 'why': 'Wall stress tracks <b>dP/dt</b>. Vasodilator first &rarr; reflex tachy &rarr; propagation. '
        'Or lowest BP that perfuses. BB contraindicated &rarr; IV dilt/verapamil. Acute AR: do not '
        'slow hard. <em>Card HR &lt;60 = the 2010 target.</em>',
},
{
 ...
 'avoid': '<span class="no">ACEi, ARB, renin inhibitors, atenolol, nitroprusside, MRA</span> '
          '&mdash; Class 3 Harm.',
 'why': 'Severe range = &ge;160 or &ge;110 for 15 min. Goal is <b>not</b> normal. '
        '<b>Mg is seizure ppx, not an antihypertensive</b> (ACOG, verbatim). Capsules swallowed, '
        'never punctured or SL. 3 failed doses &rarr; call.',
},
{
 'name': 'ACS', 'src': 'fix',
 ...
 'avoid': '<span class="no">Nitroprusside</span> (coronary steal). Hydralazine. '
          ...
          'block, bronchospasm.',
 'why': 'DBP floor is physiology, not guideline: LV perfuses in diastole. COMMIT &mdash; early IV '
        'metoprolol bought no survival, +11 shocks/1000. 2025 wants <b>PO BB within 24 h</b>, not a '
        'drip. <em>Card: &ldquo;judicious nitro w/ RVMI&rdquo; is now <b>avoid</b>; PDE5i window '
        'missing entirely.</em>',
},
{
 ...
 'why': '<b>Volume-redistributed, not overloaded</b> &mdash; diuresis is not primary and must not '
        'delay NTG + PEEP. NTG here runs well above 400 mcg/min. <em>Card: split the BB line &mdash; '
        'IV contraindicated, chronic PO continued. NIPPV absent.</em>',
},
{
 'name': 'ICH', 'src': 'fix',
 ...
 'why': 'Smoothness counts as much as the number: peaks and variability worsen outcome, over-rapid '
        'drops drove the ATACH-2 renal signal. &gt;220 is thin evidence &mdash; titrate, stay above '
        '130. <em>Most out-of-date row: card band, target and floor all wrong.</em>',
},
{
 ...
 'why': '<b>220/120 is a threshold, not a target.</b> Below it, treating in 48&ndash;72 h is Class 3 '
        'No Benefit. Treat anyway for a second indication (ACS, HF, dissection, pre-eclampsia). '
        '<em>Card reads the threshold as a target and omits both post-reperfusion rules.</em>',
},
{
 ...
 'avoid': '<span class="no">Sudden profound drops.</span> Hypotension and variability count as harm '
          'too.',
 'why': '2023 guideline: evidence insufficient for any target. Once secured the logic <b>inverts</b> '
        'to permissive/induced HTN for DCI. <b>Nimodipine 60 q4h &times; 21 d is for DCI, not BP</b> '
        '&mdash; if it drops the pressure, split to 30 q2h, do not stop.',
},
{
 ...
 'why': '<b>Expert consensus, no RCT.</b> PRES is the imaging correlate; encephalopathy is a dx of '
        'exclusion confirmed by reversal. <b>Remove the trigger</b>: CNI, VEGFi, cytotoxics. '
        'Pregnant &rarr; eclampsia pathway instead.',
},
{
 ...
 'why': 'Pheo: <b>alpha before beta</b>, always. Clonidine withdrawal: restart the clonidine. '
        'Cocaine: the classic prohibition is guideline-level but weakly evidenced &mdash; modern '
        'meta-analyses show no excess death or MI, labetalol has the best data. <b>Do not stop a '
        'chronic BB for a positive screen.</b>',
},
{
 ...
 'avoid': '<span class="no">Stopping the ACEi because the Cr rose.</span> Prednisone &gt;15 mg/d '
          'precipitates it.',
 'why': 'The one emergency defined by a <em>drug</em>, not a number &mdash; it is renin-driven. '
        'Captopril for fast on/off, which is what lets you escalate q4h. <b>Continue through rising '
        'Cr and through dialysis.</b>',
},
{
 ...
 'why': 'Over-rapid lowering worsens the AKI (ATACH-2). Acute RAS blockade dilates the efferent '
...
},
{
 ...
 'why': 'The 2024 guideline is mostly a warning the other way: intraop hypotension drives myocardial '
        'injury. Hold ACEi/ARB 24 h pre-op. Consider delaying elective surgery at &ge;180/110.',
},
{
 ...
 'why': 'Their usual SBP is often 90&ndash;110, so <b>a normal-looking 140 is a 40-point '
        'emergency</b>. Most episodes need no drug. Ointment because it can be wiped off.',
},
]
